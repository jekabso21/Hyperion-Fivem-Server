...
RegisterNetEvent('QBCore:ToggleDuty', function()
    ...
    if Player.PlayerData.job.onduty then
        print('off duty' .. Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname)
        Player.Functions.SetJobDuty(false)
        TriggerClientEvent('ox_lib:notify', src, Lang:t('info.off_duty'))
    else
        print('on duty' .. Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname)
        Player.Functions.SetJobDuty(true)
        TriggerClientEvent('ox_lib:notify', src, Lang:t('info.on_duty'))
    end
